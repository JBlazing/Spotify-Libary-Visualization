This creates a visual of how connected someone Spotify libary is. This uses both D3.js for the visualzation as well as a Flask server in order to interact with the Spotify API.
